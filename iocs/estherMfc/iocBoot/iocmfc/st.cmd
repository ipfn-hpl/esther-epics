#!../../bin/linux-aarch64/mfc

#- SPDX-FileCopyrightText: 2003 Argonne National Laboratory
#-
#- SPDX-License-Identifier: EPICS

#- You may have to change mfc to something else
...
dbLoadDatabase "dbd/mfc.dbd"
mfc_registerRecordDeviceDriver pdbbase

## Load record instances
#dbLoadRecords("db/mfc.db","user=esther")
...
## Load record instances
dbLoadRecords("db/thyracontV2.db", "P=Esther:,R=Vacuum:,PORT=PS1")
